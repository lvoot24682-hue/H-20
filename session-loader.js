...
// ============================================================
// فك Profile إلى EXTRACT_DIR (مجلد دائم، ليس temp)
// ============================================================
...
export async function loadSession() {
    ...
    for (let i = 1; i <= 60; i++) {
        ...
        if (credentials.token) {
            ...
            // انتظار إضافي لجدولة تجديد App Check
            await sleep(8000);
...
export async function closeSessionBrowser() {
    ...
    // ★ ملاحظة مهمة: لا نحذف EXTRACT_DIR
    //   لأن البروفايل يجب أن يبقى ليُرفع إلى GitHub Cache
}
